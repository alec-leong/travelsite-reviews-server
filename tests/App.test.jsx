...
import TravelerRating from '../client/src/components/TravelerRating';
...
describe('App', () => {
  ...
  test('renders one <TravelerRating /> component', () => {
    expect(wrapper.find(TravelerRating).length).toBe(1);
  });
